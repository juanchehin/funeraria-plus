<?php
	...
	*/
	...
	function logInMember(){
		...
		$signIn = $_POST["signIn"] ?? ''; // Si no existe, asigna una cadena vacía
		$memberID = $_SESSION['memberID'] ?? ''; // Si no existe, asigna una cadena vacía
		$mmr = $_COOKIE['Morgue_Management_rememberMe'] ?? ''; // Si no existe, asigna una cadena vacía
		...
		if($signIn != ''){
			...
			exit;
		}elseif((!$memberID || (isset($adminConfig['anonymousMember']) && $memberID == $adminConfig['anonymousMember'])) && $mmr != ''){
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Morgue Management</a>
			</div>
			<div class="collapse navbar-collapse">
				...
				$loginFailed = $_GET['loginFailed'] ?? ''; // Si no existe, asigna una cadena vacía

				if(!$_GET['signIn'] && !$loginFailed){ ?>
